...
const StaticNodeFormatter_1 = require("../src/TypeFormatter/StaticNodeFormatter");
const UnknownSymbolTypeFormatter_1 = require("../src/TypeFormatter/UnknownSymbolTypeFormatter");
function createFormatter(config, augmentor) {
    ...
    chainTypeFormatter
        ...
        .addTypeFormatter(new AnyTypeFormatter_1.AnyTypeFormatter(config))
        .addTypeFormatter(new UndefinedTypeFormatter_1.UndefinedTypeFormatter())
        .addTypeFormatter(new UnknownTypeFormatter_1.UnknownTypeFormatter(config))
        ...
        .addTypeFormatter(new FunctionTypeFormatter_1.FunctionTypeFormatter(circularReferenceTypeFormatter, config))
        .addTypeFormatter(new StaticNodeFormatter_1.StaticNodeFormatter())
        .addTypeFormatter(new UnknownSymbolTypeFormatter_1.UnknownSymbolTypeFormatter(config));
