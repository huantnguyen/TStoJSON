...
const NotKnownNodeParser_1 = require("../src/NodeParser/NotKnownNodeParser");
...
const PromiseNodeParser_1 = require("../src/NodeParser/PromiseNodeParser");
...
const SkippedNodeParser_1 = require("../src/NodeParser/SkippedNodeParser");
const SkippedTypeParser_1 = require("../src/NodeParser/SkippedTypeParser");
...
const VoidKeywordTypeParser_1 = require("../src/NodeParser/VoidKeywordTypeParser");
const VoidTypeNodeParser_1 = require("../src/NodeParser/VoidTypeNodeParser");
const RecursionTypeParser_1 = require("../src/RecursionTypeParser");
const TopRefNodeParser_1 = require("../src/TopRefNodeParser");
function createParser(program, config, augmentor) {
    const typeChecker = program.getTypeChecker();
    const chainNodeParser = new ChainNodeParser_1.ChainNodeParser(typeChecker, [], config);
    const mergedConfig = { ...Config_1.DEFAULT_CONFIG, ...config };
    function withExpose(nodeParser) {
        return new ExposeNodeParser_1.ExposeNodeParser(typeChecker, nodeParser, mergedConfig.expose, mergedConfig.jsDoc, mergedConfig);
    }
    ...
    function withCircular(nodeParser) {
        return new CircularReferenceNodeParser_1.CircularReferenceNodeParser(nodeParser, mergedConfig);
    }
    if (augmentor) {
        augmentor(chainNodeParser);
    }
    chainNodeParser
        .addNodeParser(new SkippedTypeParser_1.SkippedTypeParser(config))
        .addNodeParser(new SkippedNodeParser_1.SkippedNodeParser(config))
        .addNodeParser(new PromiseNodeParser_1.PromiseNodeParser(typeChecker))
        .addNodeParser(new HiddenTypeNodeParser_1.HiddenNodeParser(typeChecker))
        .addNodeParser(new RecursionTypeParser_1.RecursionTypeParser(typeChecker, chainNodeParser, config))
        ...
        .addNodeParser(new TypeReferenceNodeParser_1.TypeReferenceNodeParser(typeChecker, chainNodeParser, mergedConfig))
        .addNodeParser(new ExpressionWithTypeArgumentsNodeParser_1.ExpressionWithTypeArgumentsNodeParser(typeChecker, chainNodeParser, mergedConfig))
        .addNodeParser(new IndexedAccessTypeNodeParser_1.IndexedAccessTypeNodeParser(chainNodeParser))
        .addNodeParser(new TypeofNodeParser_1.TypeofNodeParser(typeChecker, chainNodeParser, mergedConfig))
        .addNodeParser(new MappedTypeNodeParser_1.MappedTypeNodeParser(chainNodeParser, mergedConfig.additionalProperties, mergedConfig))
        ...
        .addNodeParser(new UnionNodeParser_1.UnionNodeParser(typeChecker, chainNodeParser, mergedConfig))
        ...
        .addNodeParser(withCircular(withExpose(withJsDoc(new TypeAliasNodeParser_1.TypeAliasNodeParser(typeChecker, chainNodeParser, mergedConfig)))))
        .addNodeParser(withExpose(withJsDoc(new EnumNodeParser_1.EnumNodeParser(typeChecker, mergedConfig))))
        .addNodeParser(withCircular(withExpose(withJsDoc(new InterfaceAndClassNodeParser_1.InterfaceAndClassNodeParser(typeChecker, withJsDoc(chainNodeParser), mergedConfig.additionalProperties, mergedConfig)))))
        .addNodeParser(withCircular(withExpose(withJsDoc(new TypeLiteralNodeParser_1.TypeLiteralNodeParser(withJsDoc(chainNodeParser), mergedConfig.additionalProperties, mergedConfig)))))
        .addNodeParser(withCircular(withExpose(withJsDoc(new FunctionNodeParser_1.FunctionNodeParser(typeChecker, withJsDoc(chainNodeParser), mergedConfig)))))
        .addNodeParser(new FunctionNodeParser_1.FunctionNodeParser(typeChecker, withJsDoc(chainNodeParser), mergedConfig))
        .addNodeParser(new VoidKeywordTypeParser_1.VoidKeywordTypeParser())
        .addNodeParser(new ArrayNodeParser_1.ArrayNodeParser(chainNodeParser))
        .addNodeParser(new NotKnownNodeParser_1.NotKnownNodeParser(config));
