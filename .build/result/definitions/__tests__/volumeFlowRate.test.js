...
test("mm3/s to l/s", () => {
  ...
  expect(convert(1e6).from("mm3/s").to("l/s")).toBe(1);
});
test("cm3/s to l/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
...
test("m3/s to l/s", () => {
  ...
  expect(convert(1).from("m3/s").to("l/s")).toBe(1e3);
});
test("km3/s to l/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
  });
  expect(convert(1).from("km3/s").to("l/s")).toBe(1e12);
});
test("l/s to ml/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
  });
  expect(convert(1).from("l/s").to("ml/s")).toBe(1e3);
});
test("dl/s to ml/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
  });
  expect(convert(10).from("dl/s").to("ml/s")).toBe(1e3);
});
test("cl/s to ml/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
  });
  expect(convert(100).from("cl/s").to("ml/s")).toBe(1e3);
});
test("ml/s to ml/s", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
...
test("l/s to m3/s", () => {
  ...
  expect(convert(1).from("l/s").to("m3/s")).toBe(1e-3);
});
test("m3/s to m3/h", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
...
test("kl/min to l/h", () => {
  ...
  expect(convert(1).from("kl/min").to("l/h")).toBeCloseTo(6e4);
});
test("l/s to m3/h", () => {
  const convert = (0, import__.default)({
    volumeFlowRate: import_volumeFlowRate.default
...
//# sourceMappingURL=volumeFlowRate.test.js.map
